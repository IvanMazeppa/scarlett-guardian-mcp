...
**Status:** plan-of-record (Operator ACK 2026-07-22)  
**Source:** GPT Sol plan mode → Cursor plan `ops_revision_archival_07e388a0`  
**Copied to repo:** 2026-07-22 (Grok Build)  
**Frozen Operator decisions:**  
- ARCH-1 phased: browser download first; Guardian `backups/threads/` endpoint later (ARCH-1B)  
- Edited Benjamin regen: held, provenance-tagged stage only; never auto-approve  

**Implementation rule:** one WP per session; start with **OPS-REV-0** (docs). Code WPs need explicit “go” + WP id.
...
### OPS-REV-0 — Operator contract and safe-revision runbook (S, must-have) — **DONE 2026-07-22**
...
- Delivered: `rag-memory-mcp/docs/single-agent-ooc-prefix-v5.txt`, `docs/operator-how-to-regenerate-safely.md`, evidence `wp-ops-rev-0-evidence-2026-07-22.md`; pointer in `grok-test-setup-and-ooc-continuation-2026-07-15.md`.
