...
| **OPS-REV + ARCH plan** | **ACK 2026-07-22** | Plan-of-record: `wp-ops-revision-and-archive-plan-2026-07-22.md` (regen/edit/OOC rewrite contract + phased archival). Prompt used: `prompt-sol-ops-revision-and-archive-plan-2026-07-21.md`. **OPS-REV-0** docs first; **OPS-REV-1** first code after “go”. ARCH-1A download → ARCH-1B Guardian endpoint. |
