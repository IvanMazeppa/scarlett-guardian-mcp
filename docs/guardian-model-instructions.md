...
1. Call `guardian_memory_preflight` with Benjamin's latest user message.
2. Read the returned Guardian report.
...
5. If `proceed_recommendation` is `proceed`, write Scarlett grounded in the report.
